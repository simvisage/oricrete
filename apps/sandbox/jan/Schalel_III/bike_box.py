...
def get_constrained_YCP(L_x, L_y, n_x, n_y, d, n_steps):
    ...
    m = Masking(source = lift, F_mask=[ 42, 96, 43, 97, 0, 54, 1, 24, 78, 6, 12 ,36, 90, 18, 72, 19, 48, 102, 49, 103, 46, 100, 47, 101, 58, 5, 59, 29, 83, 65, 52, 106, 53, 107, 76, 23, 77, 41, 95, 71])
